    ...
    >
      <div className="inline-flex flex-col items-center space-y-6 p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-red-100 max-w-md mx-auto">
        ...
        <div className="flex flex-col space-y-2 w-full">
          <button
            onClick={onRetry}
            className="inline-flex items-center justify-center px-4 py-2 bg-teal-600 text-white font-medium rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-200"
          >
