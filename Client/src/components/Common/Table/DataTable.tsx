...
function DataTable<T extends object>({ data, columns, pageSizes = [5, 10, 20, 50], initialPageSize = 10, isLoading = false, isError = false, errorMessage, onRetry }: DataTableProps<T>) {
              ...
              <tr>
                ...
                >
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <p className="text-lg font-semibold text-red-600">{errorMessage || "An error occurred while fetching data"}</p>
                    {onRetry && (
                      <button
                        onClick={onRetry}
