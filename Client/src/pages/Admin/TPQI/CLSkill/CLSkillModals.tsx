...
export const AddEditCLSkillModal: React.FC<AddEditCLSkillModalProps> = ({
  isOpen,
  mode,
    ...
    <Modal
      ...
      actions={
        <>
          ...
          <LoadingButton
            onClick={() => onConfirm(careerLevelId, skillId)}
            isLoading={isLoading}
...
export const DeleteCLSkillModal: React.FC<DeleteCLSkillModalProps> = ({
  isOpen,
  label,
  onClose,
  onConfirm,
