...
import { FaTimesCircle, FaRedo, FaArrowLeft, FaExclamationTriangle } from "react-icons/fa";
...
const ErrorState: React.FC<ErrorStateProps> = ({ error, source, id, retryCount, onRetry, onGoBack }) => (
  <motion.div
    key="error"
