      ...
      {sfiaSkills.length === 0 ? (
        <div className="bg-gray-50 rounded-lg p-8 text-center border border-gray-100">
          ...
          <p className="text-gray-500">
            Complete your skills assessment to see your SFIA competencies here.
          </p>
        </div>
      ) : (
          ...
          {sfiaSkills.map((skillSummary) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="ml-4 text-right bg-gray-50 rounded-lg p-3">
        ...
        <div className="mt-6 bg-gray-50 rounded-lg p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-white rounded-lg border border-blue-100">
              ...
              <div className="text-sm text-blue-700 font-medium">Total Skills</div>
            </div>
            ...
            <div className="text-center p-4 bg-white rounded-lg border border-purple-100">
              ...
              <div className="text-sm text-purple-700 font-medium">Expert Level Skills</div>
            </div>
          </div>
        </div>
      )}
